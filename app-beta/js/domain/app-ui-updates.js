...
import { getCurrentCustomer } from './cafe-session-store.js?v=3.0.63';
import { getOrderTotal } from './order-store.js?v=3.0.63';
import { getFinancialState } from './cafe-session-store.js?v=3.0.63';
import { calculateLevel } from './statistics-data.js?v=3.0.63';
...
import { renderKlartTotalDivider } from './order-ui.js?v=3.0.63';
