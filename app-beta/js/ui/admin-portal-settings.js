  ...
  function buildTabProfile(settings, institutionName) {
    ...
    const ppContent = `
      ...
      <div class="admin-field" data-pp-types-group>
        ...
        ${buildSettingRow('Profilbillede uploadet af personalet', 'Personalet kan uploade et billede af dit barn til Flango (typisk et eksisterende billede hentet fra Aula, men det kan ogs\u00e5 v\u00e6re fra en anden kilde). Billedet vises ved k\u00f8b. Flango har ingen teknisk integration med Aula.', '<label class="toggle"><input type="checkbox" data-pp-type="upload"' + (ppAulaOn ? ' checked' : '') + '><span class="toggle-track"></span></label>')}
