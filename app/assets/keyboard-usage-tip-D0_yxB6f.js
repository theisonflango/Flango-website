import{o as g}from"./app-nj0B4XHu.js";import"./platform-BDnOHEoZ.js";import"./escape-html-WL6tn7Cj.js";import"./config-and-supabase-DxdgO8Yh.js";import"./cafe-client-compatibility-51oua5GV.js";import"./session-store-DLvMKKKS.js";import"./calculator-mode-D3tQtv1P.js";import"./download-file-BhdWP-P5.js";const b="flango-keyboard-tip-dismissed",c={MIN_MOUSE_CLICKS:10,TIME_WINDOW_MS:3e5};let o=[],s=[],a=!1;function d(){try{return localStorage.getItem(b)==="true"}catch{return!1}}function x(){try{localStorage.setItem(b,"true")}catch{}}function l(t){if(!a||d())return;const n=Date.now();o.push({type:t,timestamp:n});const e=n-c.TIME_WINDOW_MS;o=o.filter(i=>i.timestamp>e),E()}function p(t){if(!a||d())return;const n=Date.now();s.push({key:t,timestamp:n});const e=n-c.TIME_WINDOW_MS;s=s.filter(i=>i.timestamp>e)}function E(){if(d())return;const n=Date.now()-c.TIME_WINDOW_MS;o.filter(i=>i.timestamp>n).length>=c.MIN_MOUSE_CLICKS&&(h(),o=[],s=[])}function h(){if(d())return;I("Hr. Flango har et tip! 😄",`
