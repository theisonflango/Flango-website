const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-B-uNCKh5.js","assets/main-BmKwP4le.css"])))=>i.map(i=>d[i]);
import{_ as q,y as F,z as N,e as A,B as K,D as B,s as p,E as O,F as D,G as P,H as R,I as V,J as U,K as J,L as w,M as G}from"./main-B-uNCKh5.js";let E=!1,_=null,a=[],y=null,L=null,v=null,m=JSON.parse(localStorage.getItem("flango_kitchen_fs_sort")||"null")||{column:"time",direction:"asc"},b=localStorage.getItem("flango_kitchen_fs_served_pos")||"merged",g=localStorage.getItem("flango_kitchen_fs_show_delete")==="true";const c=e=>v?.querySelector(e);function W(){E?T():Q()}function me(){return E}window.__flangoToggleKitchenFullscreen=W;async function Q(){_=localStorage.getItem("flango_institution_id");const e=window.__flangoGetInstitutionById?.(_);if(!e?.restaurant_mode_enabled){console.warn("[kitchen-fs] Restaurant mode not enabled");return}if(typeof window.__flangoToggleKitchenPanel=="function"){const{isKitchenModeActive:r}=await q(async()=>{const{isKitchenModeActive:s}=await import("./main-B-uNCKh5.js").then(o=>o.Q);return{isKitchenModeActive:s}},__vite__mapDeps([0,1]));r()&&window.__flangoToggleKitchenPanel(!1)}if(document.body.classList.contains("calculator-mode")){const{toggleCalculatorMode:r}=await q(async()=>{const{toggleCalculatorMode:s}=await import("./main-B-uNCKh5.js").then(o=>o.P);return{toggleCalculatorMode:s}},__vite__mapDeps([0,1]));r(!1)}const t=e.restaurant_sound||null,n=e.restaurant_serve_sound||null;F(t?`sounds/${t}`:null,n?`sounds/${n}`:null),v=Z(e),document.body.appendChild(v),E=!0,document.body.classList.add("kitchen-fullscreen-mode"),X(),j(),await Y(),oe(),L=setInterval(()=>{N(c("#kfs-active-orders"))},15e3),document.addEventListener("keydown",M)}function T(){E=!1,document.body.classList.remove("kitchen-fullscreen-mode"),y&&(p.removeChannel(y),y=null),L&&(clearInterval(L),L=null),document.removeEventListener("keydown",M),v&&(v.remove(),v=null),a=[]}function M(e){e.key==="Escape"&&T()}function Z(e){const t=document.createElement("div");t.id="kitchen-fullscreen-overlay",t.className="kitchen-fullscreen-overlay"+(g?" show-delete-btn":"");const n=e?.name||localStorage.getItem("flango_institution_name")||"";return t.innerHTML=`
