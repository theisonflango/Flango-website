...
import { supabaseClient, SUPABASE_URL } from './config-and-supabase.js?v=3.0.76';
import { CUSTOM_ICON_PREFIX, getCustomIconPath } from '../domain/products-and-cart.js?v=3.0.76';
import { getCachedProductIconUrl, batchPreWarmProductIcons, setCachedProductIconUrl } from './product-icon-cache.js?v=3.0.76';
