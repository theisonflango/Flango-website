import { playSound, showAlert, showCustomAlert, openSoundSettingsModal } from '../ui/sound-and-alerts.js?v=3.0.65';
import { initializeSoundSettings } from '../core/sound-manager.js?v=3.0.65';
import { initDebugRecorder, logDebugEvent } from '../core/debug-flight-recorder.js?v=3.0.65';
import { closeTopMostOverlay, suspendSettingsReturn, resumeSettingsReturn, showScreen, initToolbarSettings } from '../ui/shell-and-theme.js?v=3.0.65';
import { getCurrentTheme, onThemeChange } from '../ui/theme-loader.js?v=3.0.65';
import { configureHistoryModule, showTransactionsInSummary, showOverviewInSummary, resetSharedHistoryControls } from './history-and-reports.js?v=3.0.65';
import { setupSummaryModal, openSummaryModal, closeSummaryModal, exportToCSV } from './summary-controller.js?v=3.0.65';
import { setupLogoutFlow } from './logout-flow.js?v=3.0.65';
import { getFinancialState, setCurrentCustomer, getCurrentCustomer, clearEvaluation, getSelectionToken, clearCurrentCustomer } from './cafe-session-store.js?v=3.0.65';
import { getOrderTotal, setOrder, getOrder } from './order-store.js?v=3.0.65';
import { updateLoggedInUserDisplay, updateAvatarStorage, updateSelectedUserInfo } from './app-ui-updates.js?v=3.0.65';
import { updateTotalPrice, renderOrder, handleOrderListClick, addToOrder, removeLastItemFromOrder, removeOneItemByName } from './order-ui.js?v=3.0.65';
import { renderProductsInModal, renderProductsGrid, createProductManagementUI, updateProductQuantityBadges } from '../ui/product-management.js?v=3.0.65';
...
} from './products-and-cart.js?v=3.0.65';
import { getChildSugarPolicySnapshot, getInstitutionSugarPolicy, getCachedCheckSugarPolicy, getUnhealthySnapshotFromSalesCache } from './purchase-limits.js?v=3.0.65';
import { showPinModal } from '../ui/user-modals.js?v=3.0.65';
import { setupAvatarPicker } from '../ui/avatar-picker.js?v=3.0.65';
import { setupKeyboardShortcuts } from '../ui/keyboard-shortcuts.js?v=3.0.65';
import { setupRuntimeUIEvents } from '../ui/runtime-ui-events.js?v=3.0.65';
import { initCalculatorMode } from '../ui/calculator-mode.js?v=3.0.65';
// VIGTIGT: shift-timer importeres FØR clerk-login-modal for at sætte window.__flangoOpenShiftTimer
import { initShiftTimer } from './shift-timer.js?v=3.0.65';
import { setupClerkLoginButton } from '../ui/clerk-login-modal.js?v=3.0.65';
import {
    handleCompletePurchase,
    handleUndoLastSale,
    handleUndoPreviousSale,
} from './purchase-flow.js?v=3.0.65';
import { onBalanceChange } from '../core/balance-manager.js?v=3.0.65';
import { startRealtimeSync } from '../core/realtime-sync.js?v=3.0.65';
import { initToastNotifications, clearAllToasts } from '../ui/toast-notifications.js?v=3.0.65';
import { setupCustomerPickerFlow } from './customer-picker-flow.js?v=3.0.65';
import { setupAdminFlow, loadUsersAndNotifications } from './admin-flow.js?v=3.0.65';
import { initDeletionRequests, checkPendingDeletionRequests } from './deletion-requests.js?v=3.0.65';
import { startInactivityTimeout } from '../core/inactivity-timeout.js?v=3.0.65';
import { logAuditEvent } from '../core/audit-events.js?v=3.0.65';
import { setupProductAssortmentFlow } from './product-assortment-flow.js?v=3.0.65';
import { batchPreWarmProfilePictures, preWarmDefaultProfilePicture } from '../core/profile-picture-cache.js?v=3.0.65';
import { initCafeEventStrip, refreshCafeEventStrip, hideCafeEventStrip } from '../ui/cafe-event-strip.js?v=3.0.65';
import { invalidateCafeEventsCache } from './cafe-events.js?v=3.0.65';
import { isAuthAdminUser, openDbHistoryModal } from '../ui/db-history.js?v=3.0.65';
import {
    setCurrentAdmin,
    getCurrentAdmin,
    setCurrentClerk,
    ...
    setSessionStartTime,
    getSessionStartTime,
} from './session-store.js?v=3.0.65';
...
export async function startApp() {
    ...
    const { initKeyboardUsageTip } = await import('../ui/keyboard-usage-tip.js?v=3.0.65');
            ...
            const startPress = () => {
                ...
                pressTimer = setTimeout(() => {
                    ...
                    if (typeof window.__flangoToggleKitchenFullscreen === 'function') {
                        ...
                        import('../restaurant/kitchen-fullscreen.js?v=3.0.65').then(() => {
                            window.__flangoToggleKitchenFullscreen?.();
                        }).catch(() => {
