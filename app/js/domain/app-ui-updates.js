...
import { getCurrentCustomer } from './cafe-session-store.js?v=3.0.65';
import { getOrderTotal } from './order-store.js?v=3.0.65';
import { getFinancialState } from './cafe-session-store.js?v=3.0.65';
import { calculateLevel } from './statistics-data.js?v=3.0.65';
...
import { renderKlartTotalDivider } from './order-ui.js?v=3.0.65';
