...
import { checkClassMatch, registerUserForEvent, formatEventDate, formatTime } from './event-management.js?v=3.0.69';
import { updateInstitutionCache } from './institution-store.js?v=3.0.69';
