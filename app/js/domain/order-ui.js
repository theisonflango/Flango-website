...
import { getProductIconInfo, addProductToOrder, removeProductFromOrder, getBulkDiscountSummary } from './products-and-cart.js?v=3.0.64';
import { canChildPurchase } from './purchase-limits.js?v=3.0.64';
import { playSound } from '../ui/sound-and-alerts.js?v=3.0.64';
import { getCurrentCustomer, clearEvaluation } from './cafe-session-store.js?v=3.0.64';
import { MAX_ITEMS_PER_ORDER } from '../core/constants.js?v=3.0.64';
import { formatKr } from '../ui/confirm-modals.js?v=3.0.64';
import { getCurrentTheme } from '../ui/theme-loader.js?v=3.0.64';
import { updateKlartCartCountBadge } from './app-ui-updates.js?v=3.0.64';
