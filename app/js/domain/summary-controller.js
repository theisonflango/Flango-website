...
import { fetchSummaryData, invalidateSummaryData } from './summary-data.js?v=3.0.62';
import { renderSummaryTable } from '../ui/summary-ui.js?v=3.0.62';
...
import {
    ...
    setOnlyTestUsers,
    setEmployeeRole
} from './summary-store.js?v=3.0.62';
import { setupPurchaseProfilesUI, openPurchaseProfilesView, closePurchaseProfilesView } from '../ui/purchase-profiles-ui.js?v=3.0.62';
import { initStatisticsUI, renderStatisticsView, refreshStatistics } from '../ui/statistics-ui.js?v=3.0.62';
import { setSelectedUserId } from './purchase-profiles.js?v=3.0.62';
