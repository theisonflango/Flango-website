...
import { sortOrdersByColumn } from './kitchen-sort.js?v=3.0.67';
import {
...
} from './kitchen-sound.js?v=3.0.67';
...
async function openFullscreen() {
    ...
    if (typeof window.__flangoToggleKitchenPanel === 'function') {
        const { isKitchenModeActive } = await import('./kitchen-inline-panel.js?v=3.0.67');
    ...
    if (document.body.classList.contains('calculator-mode')) {
        const { toggleCalculatorMode } = await import('../ui/calculator-mode.js?v=3.0.67');
