...
import { sortOrdersByColumn } from './kitchen-sort.js?v=3.0.69';
import {
...
} from './kitchen-sound.js?v=3.0.69';
...
async function openFullscreen() {
    ...
    if (typeof window.__flangoToggleKitchenPanel === 'function') {
        const { isKitchenModeActive } = await import('./kitchen-inline-panel.js?v=3.0.69');
