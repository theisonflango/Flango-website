...
import { getOrder, setOrder } from '../domain/order-store.js?v=3.0.76';
import { playSound, showCustomAlert } from '../ui/sound-and-alerts.js?v=3.0.76';
import { STANDARD_ICONS } from '../core/product-icon-utils.js?v=3.0.76';
import { CUSTOM_ICON_PREFIX } from '../domain/products-and-cart.js?v=3.0.76';
