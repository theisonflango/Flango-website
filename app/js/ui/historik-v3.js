...
import { getCurrentAdmin, getInstitutionId, isCurrentUserAdmin } from '../domain/session-store.js?v=3.0.69';
import { initPurchaseProfiles, getChartData as ppGetChartData } from '../domain/purchase-profiles.js?v=3.0.69';
import {
...
} from '../domain/historik-data.js?v=3.0.69';
import { exportSalesReport, exportAllBalances, exportNegativeBalances, exportTransactionsCsv, exportClerkReport, exportPeriodReport } from './historik-export.js?v=3.0.69';
import { showConfirmModal } from './confirm-modals.js?v=3.0.69';
import { showCustomAlert } from './sound-and-alerts.js?v=3.0.69';
import { invalidateTodaysSalesCache } from '../domain/purchase-limits.js?v=3.0.69';
import {
...
} from './historik-v3-charts.js?v=3.0.69';

// ─── CONSTANTS ───
import { getCachedProductIconUrl } from '../core/product-icon-cache.js?v=3.0.69';
