...
import { isCalculatorModeActive, handleCalculatorKeyboard } from './calculator-mode.js?v=3.0.76';
...
export function setupKeyboardShortcuts({
    ...
    const adminKeydownHandler = (event) => {
        ...
        if (key === 'b') {
            event.preventDefault();
            import('./user-admin-panel.js?v=3.0.76').then(m => m.openUserAdminPanel());
        }
    };
