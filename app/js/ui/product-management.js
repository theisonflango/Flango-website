...
import { getProductIconInfo, PRODUCT_ICON_CLASS_MAP } from '../domain/products-and-cart.js?v=3.0.76';
import { isCurrentUserAdmin } from '../domain/session-store.js?v=3.0.76';
...
} from '../core/product-icon-utils.js?v=3.0.76';
...
export async function renderProductsGrid(allProducts, productsContainer, onProductClick, currentCustomer = null) {
    ...
    if (currentCustomer?.id) {
        ...
        const { getEffectiveProductForChild } = await import('../domain/products-and-cart.js?v=3.0.76');
        const childContext = {
...
export function createProductManagementUI(options = {}) {
    ...
    if (manageIconsBtn && iconMgmtModal) {
        ...
        async function loadIconManagementGrid() {
            ...
            const { STANDARD_ICONS } = await import('../core/product-icon-utils.js?v=3.0.76');
