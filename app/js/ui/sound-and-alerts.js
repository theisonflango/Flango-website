...
function renderSoundSettingsModal() {
    ...
    const availableSounds = {
        'Tilføj Vare': [{ name: 'Add 1', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Add%20Item/Add1.mp3' }, { name: 'Add 2', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Add%20Item/Add2.mp3' }],
        'Fjern Vare': [{ name: 'Slet', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Delete%20Item/Slet.mp3' }, { name: 'Slet 1', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Delete%20Item/Slet1.mp3' }, { name: 'Slet 2', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Delete%20Item/Slet2.mp3' }, { name: 'Slet 3', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Delete%20Item/Slet3.mp3' }, { name: 'Slet 4', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Delete%20Item/Slet4.mp3' }],
        'Gennemfør Køb': [{ name: 'Accept 1', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Accept/accepter-1.mp3' }, { name: 'Accept 2', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Accept/accepter-2.mp3' }, { name: 'Accept 3', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Accept/accepter-3.mp3' }, { name: 'Accept 4', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Accept/accepter-4.mp3' }, { name: 'Accept 5', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Accept/accepter-5.mp3' }, { name: 'Accept 6', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Accept/accepter-6.mp3' }, { name: 'Accept 7', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Accept/accepter-7.mp3' }],
        'Fejl': [{ name: 'Fejl 1', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Error/Fejl1.mp3' }, { name: 'Fejl 2', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Error/Fejl2.mp3' }, { name: 'Fejl 3', url: 'https://jbknjgbpghrbrstqwoxj.supabase.co/storage/v1/object/public/sounds/Error/Fejl3.mp3' }],
    };
