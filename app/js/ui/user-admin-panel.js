...
import { getCachedProfilePictureUrl, batchPreWarmProfilePictures, invalidateProfilePictureCache, getDefaultProfilePicture, getDefaultProfilePictureAsync } from '../core/profile-picture-cache.js?v=3.0.79';
import { escapeHtml } from '../core/escape-html.js?v=3.0.79';
import { openHistorikV3ForUser } from './historik-v3.js?v=3.0.79';
...
function openPPLightbox(entry, mode = 'all', userRows = null) {
    ...
    function renderLightboxContent() {
        ...
        lb.querySelector('.uap-lb-activate')?.addEventListener('click', async (e) => {
            e.stopPropagation();
            const { applyProfilePicture } = await import('../core/profile-picture-utils.js?v=3.0.79');
        ...
        lb.querySelector('.uap-lb-edit')?.addEventListener('click', (e) => {
            ...
            editor.querySelector('.uap-crop-save').onclick = async () => {
                ...
                try {
                    ...
                    const { invalidateProfilePictureCache } = await import('../core/profile-picture-cache.js?v=3.0.79');
        ...
        lb.querySelector('.uap-lb-delete')?.addEventListener('click', async (e) => {
            ...
            const { removeProfilePicture } = await import('../core/profile-picture-utils.js?v=3.0.79');
