...
import { getInstitutionId } from '../domain/session-store.js?v=3.0.69';
import { getCachedProfilePictureUrl, batchPreWarmProfilePictures, invalidateProfilePictureCache, getDefaultProfilePicture, getDefaultProfilePictureAsync } from '../core/profile-picture-cache.js?v=3.0.69';
import { escapeHtml } from '../core/escape-html.js?v=3.0.69';
import { openHistorikV3ForUser } from './historik-v3.js?v=3.0.69';
...
function openPPLightbox(entry, mode = 'all', userRows = null) {
    ...
    function renderLightboxContent() {
        ...
        lb.querySelector('.uap-lb-activate')?.addEventListener('click', async (e) => {
            e.stopPropagation();
            const { applyProfilePicture } = await import('../core/profile-picture-utils.js?v=3.0.69');
        ...
        lb.querySelector('.uap-lb-edit')?.addEventListener('click', (e) => {
            ...
            editor.querySelector('.uap-crop-save').onclick = async () => {
                ...
                try {
                    ...
                    const { invalidateProfilePictureCache } = await import('../core/profile-picture-cache.js?v=3.0.69');
        ...
        lb.querySelector('.uap-lb-delete')?.addEventListener('click', async (e) => {
            ...
            const { removeProfilePicture } = await import('../core/profile-picture-utils.js?v=3.0.69');
