import{o as g}from"./app-BhQUCGVu.js";import"./platform-DcD9ajzk.js";import"./escape-html-LPhAFi3I.js";import"./config-and-supabase-tGHh46h9.js";import"./cafe-client-compatibility-DCY2GzC-.js";import"./session-store-DLvMKKKS.js";import"./calculator-mode-D-0Jyten.js";import"./wallet-balances-B95UWg_6.js";import"./download-file-pXdzGD5h.js";const b="flango-keyboard-tip-dismissed",c={MIN_MOUSE_CLICKS:10,TIME_WINDOW_MS:3e5};let o=[],s=[],a=!1;function d(){try{return localStorage.getItem(b)==="true"}catch{return!1}}function x(){try{localStorage.setItem(b,"true")}catch{}}function l(t){if(!a||d())return;const i=Date.now();o.push({type:t,timestamp:i});const e=i-c.TIME_WINDOW_MS;o=o.filter(n=>n.timestamp>e),E()}function p(t){if(!a||d())return;const i=Date.now();s.push({key:t,timestamp:i});const e=i-c.TIME_WINDOW_MS;s=s.filter(n=>n.timestamp>e)}function E(){if(d())return;const i=Date.now()-c.TIME_WINDOW_MS;o.filter(n=>n.timestamp>i).length>=c.MIN_MOUSE_CLICKS&&(h(),o=[],s=[])}function h(){if(d())return;I("Hr. Flango har et tip! 😄",`
