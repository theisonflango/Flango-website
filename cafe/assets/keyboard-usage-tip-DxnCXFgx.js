import{o as g}from"./app-CVYFbey3.js";import"./platform-qyiS8StQ.js";import"./escape-html-CPboFElj.js";import"./config-and-supabase-C9IyeGNd.js";import"./cafe-client-compatibility-BKR5-Ls7.js";import"./session-store-DLvMKKKS.js";import"./calculator-mode-DsI3V8X_.js";import"./wallet-balances-3RttQEZA.js";import"./download-file-_YNye86Y.js";const b="flango-keyboard-tip-dismissed",c={MIN_MOUSE_CLICKS:10,TIME_WINDOW_MS:3e5};let o=[],s=[],a=!1;function d(){try{return localStorage.getItem(b)==="true"}catch{return!1}}function x(){try{localStorage.setItem(b,"true")}catch{}}function l(t){if(!a||d())return;const i=Date.now();o.push({type:t,timestamp:i});const e=i-c.TIME_WINDOW_MS;o=o.filter(n=>n.timestamp>e),E()}function p(t){if(!a||d())return;const i=Date.now();s.push({key:t,timestamp:i});const e=i-c.TIME_WINDOW_MS;s=s.filter(n=>n.timestamp>e)}function E(){if(d())return;const i=Date.now()-c.TIME_WINDOW_MS;o.filter(n=>n.timestamp>i).length>=c.MIN_MOUSE_CLICKS&&(h(),o=[],s=[])}function h(){if(d())return;I("Hr. Flango har et tip! 😄",`
