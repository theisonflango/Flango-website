const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/kitchen-inline-panel-C3rrZAE5.js","assets/platform-BMVduvzW.js","assets/config-and-supabase-Ca1yaE6h.js","assets/cafe-client-compatibility-B8AgC_7o.js","assets/kitchen-sound-BD3tflA9.js","assets/escape-html-BujfjBBf.js","assets/calculator-mode-CGPLfx3L.js","assets/session-store-DLvMKKKS.js"])))=>i.map(i=>d[i]);
import{_ as I}from"./platform-BMVduvzW.js";import{s as p}from"./config-and-supabase-Ca1yaE6h.js";import{e as A,s as w}from"./escape-html-BujfjBBf.js";import{i as N,u as F,t as K,a as B,b as O,p as D,r as P,g as R,c as V,d as U,e as J,f as W}from"./kitchen-sound-BD3tflA9.js";import"./cafe-client-compatibility-B8AgC_7o.js";let E=!1,_=null,a=[],y=null,L=null,v=null,m=JSON.parse(localStorage.getItem("flango_kitchen_fs_sort")||"null")||{column:"time",direction:"asc"},b=localStorage.getItem("flango_kitchen_fs_served_pos")||"merged",g=localStorage.getItem("flango_kitchen_fs_show_delete")==="true";const c=e=>v?.querySelector(e);function G(){E?T():Z()}function ge(){return E}window.__flangoToggleKitchenFullscreen=G;async function Z(){_=localStorage.getItem("flango_institution_id");const e=window.__flangoGetInstitutionById?.(_);if(!e?.restaurant_mode_enabled){console.warn("[kitchen-fs] Restaurant mode not enabled");return}if(typeof window.__flangoToggleKitchenPanel=="function"){const{isKitchenModeActive:r}=await I(async()=>{const{isKitchenModeActive:s}=await import("./kitchen-inline-panel-C3rrZAE5.js");return{isKitchenModeActive:s}},__vite__mapDeps([0,1,2,3,4,5]));r()&&window.__flangoToggleKitchenPanel(!1)}if(document.body.classList.contains("calculator-mode")){const{toggleCalculatorMode:r}=await I(async()=>{const{toggleCalculatorMode:s}=await import("./calculator-mode-CGPLfx3L.js").then(o=>o.q);return{toggleCalculatorMode:s}},__vite__mapDeps([6,2,1,3,5,7]));r(!1)}const t=e.restaurant_sound||null,n=e.restaurant_serve_sound||null;N(t?`sounds/${t}`:null,n?`sounds/${n}`:null),v=Q(e),document.body.appendChild(v),E=!0,document.body.classList.add("kitchen-fullscreen-mode"),X(),M(),await Y(),oe(),L=setInterval(()=>{F(c("#kfs-active-orders"))},15e3),document.addEventListener("keydown",H)}function T(){E=!1,document.body.classList.remove("kitchen-fullscreen-mode"),y&&(p.removeChannel(y),y=null),L&&(clearInterval(L),L=null),document.removeEventListener("keydown",H),v&&(v.remove(),v=null),a=[]}function H(e){e.key==="Escape"&&T()}function Q(e){const t=document.createElement("div");t.id="kitchen-fullscreen-overlay",t.className="kitchen-fullscreen-overlay"+(g?" show-delete-btn":"");const n=e?.name||localStorage.getItem("flango_institution_name")||"";return t.innerHTML=`
