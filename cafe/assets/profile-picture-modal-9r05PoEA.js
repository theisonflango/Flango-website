import{g as he,b as le,p as Z,u as ne,s as pe,f as xe,d as _e,e as ke,h as se,A as we,j as Le,k as Se}from"./app-CXRb8dZ3.js";import{r as Ae}from"./roster-DZLPddDL.js";import{e as h}from"./escape-html-2-74p0RX.js";import{s as B}from"./session-store-CTcpcGCf.js";import{f as Ee}from"./calculator-mode-hPJRWB_2.js";import{a as ae}from"./backend-config-D_9xaUNr.js";import"./platform-ClK6hiXM.js";import"./staff-auth-DLjdrZ9g.js";import"./portal-api-EPGjFIz9.js";import"./download-file-dgCZqk-A.js";import"./cafe-client-compatibility-D5Itg9a3.js";function $e(e){const t=!!e?.profile_pictures_ai_enabled;return{masterOn:t,usable:t&&e?.ai_provider_openai!==!1}}async function Ne(e,t={}){const{onSaved:b,showCustomAlert:k}=t,c=window.__flangoGetInstitutionById?.(e.institution_id);if(!c)return;let g=c.profile_picture_types||["upload","camera","library"];const o=e.id!=="__default__"&&await he(c),n=document.createElement("div");n.className="profile-pic-modal-overlay";const r=document.createElement("div");r.className="profile-pic-modal";const y=e.number?` (${e.number})`:"";r.innerHTML=`
