import{g as he,b as xe,d as ne,p as ee,u as pe,s as se,f as _e,e as ke,h as we,j as ce,A as Le,k as Se,l as Ae}from"./app-B-sP5qkY.js";import{r as Ee}from"./roster-DmTLAUfK.js";import{e as h}from"./escape-html-DenDA1C9.js";import{s as B}from"./session-store-Cx51lRnK.js";import{f as $e}from"./calculator-mode-BlHg1HlP.js";import{a as oe}from"./backend-config-D_9xaUNr.js";import"./platform-DmDvCOrB.js";import"./staff-auth-DLjdrZ9g.js";import"./portal-api-ColB9ivi.js";import"./download-file-edyH3npu.js";import"./cafe-client-compatibility-CP9ax7CG.js";function qe(e){const t=e?.media||{},v=!!t.profile_pictures_ai_enabled;return{masterOn:v,usable:v&&t.ai_provider_openai!==!1}}async function We(e,t={}){const{onSaved:v,showCustomAlert:k}=t,d=window.__flangoGetInstitutionById?.(e.institution_id);if(!d)return;let g=d.media?.profile_picture_types||["upload","camera","library"];const o=e.id!=="__default__"&&await he(d),u=e.profile_picture_opt_out===!0,r=document.createElement("div");r.className="profile-pic-modal-overlay";const l=document.createElement("div");l.className="profile-pic-modal";const p=e.number?` (${e.number})`:"";l.innerHTML=`
