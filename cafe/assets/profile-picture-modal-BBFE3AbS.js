import{g as he,b as le,p as Z,u as ne,s as se,f as xe,c as _e,d as ke,e as pe,A as we,h as Le,r as Se}from"./app-1R4MXN3t.js";import{e as h}from"./escape-html-D3ExTbpP.js";import{s as R}from"./config-and-supabase-DfjCyJKb.js";import{f as Ae}from"./calculator-mode-CIx-BWgR.js";import{a as ae}from"./cafe-client-compatibility-DQ6QKMfX.js";import"./platform-9W_y_fBl.js";import"./session-store-DLvMKKKS.js";import"./download-file-DKCAOtvA.js";function Ee(e){const t=!!e?.profile_pictures_ai_enabled;return{masterOn:t,usable:t&&e?.ai_provider_openai!==!1}}async function Ke(e,t={}){const{onSaved:b,showCustomAlert:k}=t,c=window.__flangoGetInstitutionById?.(e.institution_id);if(!c)return;let g=c.profile_picture_types||["upload","camera","library"];const o=e.id!=="__default__"&&await he(c),n=document.createElement("div");n.className="profile-pic-modal-overlay";const r=document.createElement("div");r.className="profile-pic-modal";const y=e.number?` (${e.number})`:"";r.innerHTML=`
