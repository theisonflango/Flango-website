import{g as he,b as le,p as Z,u as ne,s as se,f as xe,c as _e,d as ke,e as pe,A as we,h as Le}from"./app-D4KPCrA7.js";import{r as Se}from"./wallet-balances-DQuVfQXA.js";import{e as h}from"./escape-html-DEOxa15l.js";import{s as R}from"./config-and-supabase-T12kBL5D.js";import{f as Ae}from"./calculator-mode-BjX1aYHC.js";import{a as ae}from"./cafe-client-compatibility-Ctz4B9k5.js";import"./platform-BBtV3ROO.js";import"./session-store-DLvMKKKS.js";import"./download-file-CpnK5WkU.js";function Ee(e){const t=!!e?.profile_pictures_ai_enabled;return{masterOn:t,usable:t&&e?.ai_provider_openai!==!1}}async function Ve(e,t={}){const{onSaved:b,showCustomAlert:k}=t,c=window.__flangoGetInstitutionById?.(e.institution_id);if(!c)return;let g=c.profile_picture_types||["upload","camera","library"];const o=e.id!=="__default__"&&await he(c),n=document.createElement("div");n.className="profile-pic-modal-overlay";const r=document.createElement("div");r.className="profile-pic-modal";const y=e.number?` (${e.number})`:"";r.innerHTML=`
