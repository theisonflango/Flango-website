import{g as he,b as le,p as Z,u as ne,s as pe,f as xe,c as _e,d as ke,e as se,A as we,h as Le,j as Se}from"./app-IPCUfYEZ.js";import{r as Ae}from"./roster-tj-Ut0sl.js";import{e as h}from"./escape-html-DqKpVVG2.js";import{s as B}from"./session-store-DLYpzQ1j.js";import{f as Ee}from"./calculator-mode-p0mUQxXu.js";import{a as ae}from"./backend-config-D_9xaUNr.js";import"./platform-C7BwLi9i.js";import"./staff-auth-atJVIXqF.js";import"./portal-api-3U5DRw0l.js";import"./download-file-BWOJ0L6R.js";import"./cafe-client-compatibility-CurY96cp.js";function $e(e){const t=!!e?.profile_pictures_ai_enabled;return{masterOn:t,usable:t&&e?.ai_provider_openai!==!1}}async function Ne(e,t={}){const{onSaved:b,showCustomAlert:k}=t,c=window.__flangoGetInstitutionById?.(e.institution_id);if(!c)return;let g=c.profile_picture_types||["upload","camera","library"];const o=e.id!=="__default__"&&await he(c),n=document.createElement("div");n.className="profile-pic-modal-overlay";const r=document.createElement("div");r.className="profile-pic-modal";const y=e.number?` (${e.number})`:"";r.innerHTML=`
