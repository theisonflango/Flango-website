import{g as he,b as le,p as Z,u as ne,s as pe,f as xe,c as _e,d as ke,e as se,A as we,h as Le,j as Se}from"./app-BAEW4AVd.js";import{r as Ae}from"./roster-tnMT5cMe.js";import{e as h}from"./escape-html-DyqZKNIU.js";import{s as B}from"./session-store-BiloXcEq.js";import{f as Ee}from"./calculator-mode-cPdiQJ--.js";import{a as ae}from"./backend-config-D_9xaUNr.js";import"./platform-DGIYIJgk.js";import"./staff-auth-atJVIXqF.js";import"./portal-api-CQm0XiaO.js";import"./download-file-Bk-AAWWM.js";import"./cafe-client-compatibility-HA1-67Gh.js";function $e(e){const t=!!e?.profile_pictures_ai_enabled;return{masterOn:t,usable:t&&e?.ai_provider_openai!==!1}}async function Ne(e,t={}){const{onSaved:b,showCustomAlert:k}=t,c=window.__flangoGetInstitutionById?.(e.institution_id);if(!c)return;let g=c.profile_picture_types||["upload","camera","library"];const o=e.id!=="__default__"&&await he(c),n=document.createElement("div");n.className="profile-pic-modal-overlay";const r=document.createElement("div");r.className="profile-pic-modal";const y=e.number?` (${e.number})`:"";r.innerHTML=`
