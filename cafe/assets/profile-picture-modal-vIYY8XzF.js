import{g as he,b as xe,d as ne,p as ee,u as pe,s as se,f as _e,e as ke,h as we,j as ce,A as Le,k as Se,l as Ae}from"./app-xT5VMo6U.js";import{r as Ee}from"./roster-CAi0FT_J.js";import{e as h}from"./escape-html-B3hnW_nG.js";import{s as B}from"./session-store-CR6GpF0L.js";import{f as $e}from"./calculator-mode-CwK02AJ_.js";import{a as oe}from"./backend-config-D_9xaUNr.js";import"./platform-Cvciebhn.js";import"./staff-auth-DLjdrZ9g.js";import"./portal-api-_LzAkF-R.js";import"./download-file-CfHg--hZ.js";import"./cafe-client-compatibility-BgHLEM4i.js";function qe(e){const t=e?.media||{},v=!!t.profile_pictures_ai_enabled;return{masterOn:v,usable:v&&t.ai_provider_openai!==!1}}async function We(e,t={}){const{onSaved:v,showCustomAlert:k}=t,d=window.__flangoGetInstitutionById?.(e.institution_id);if(!d)return;let g=d.media?.profile_picture_types||["upload","camera","library"];const o=e.id!=="__default__"&&await he(d),u=e.profile_picture_opt_out===!0,r=document.createElement("div");r.className="profile-pic-modal-overlay";const l=document.createElement("div");l.className="profile-pic-modal";const p=e.number?` (${e.number})`:"";l.innerHTML=`
