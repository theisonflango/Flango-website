...
(function () {
  ...
  const T = [
    ...
    { name: 'Institutionens Præferencer', items: [{ l: 'Toolbar', c: '#5ba0d8' }, { l: 'Ugeplan', c: '#7aa87a' }, { l: 'Beløbsgrænse', c: '#e8734a' }, { l: 'Sukkerpolitik', c: '#e85a6f' }, { l: 'Valggruppe', c: '#5ba0d8' }, { l: 'Ekspedient-login', c: '#f4a261' }] },
  ...
  const icons = {
    ...
    'Valggruppe': '<rect x="2" y="2" width="12" height="12" rx="2"/><path d="M4.5 8l2.3 2.3 4.7-4.7"/>',
  ...
  function render() {
    ...
    if (window.innerWidth <= 767) {
      sb.querySelector('.active')?.scrollIntoView({ block: 'nearest', inline: 'nearest' });
