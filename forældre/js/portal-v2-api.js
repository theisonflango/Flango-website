...
(function () {
  ...
  window.PortalAPI = {
    ...
    // Adgangskode skiftes gennem Supabase Auth (updatePassword ovenfor).
    // Den gamle forælder-PIN og dens update-parent-pin-endpoint er fjernet 4/9-2026:
    // ingen del af portalen kaldte dem, og PIN'en logger ikke længere nogen ind.
